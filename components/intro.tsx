...
export default function Intro() {
    ...
    return (
        ...
        >
                ...
                <div className="relative">
                    ...
                    >
                        <Image
                            ...
                            width={192}
                            height={192}
                            alt="Xiaochen portrait"
                            quality="95"
                            priority={true}
                            className="h-24 w-24 rounded-full object-cover border-[0.35rem] border-white border-opacity-40 shadow-lg shadow-black/[0.03] sm:h-32 sm:w-32"
                        />
                    </motion.div>
                    <motion.span
            ...
            >
                <span className="font-bold">Hello, I&apos;m Watcharapong.</span>{" "}
                I&apos;m a{" "}
            ...
            >
                ...
                <a
                    ...
                    href="https://drive.google.com/file/d/1AGel_wbvmZM7zR6Qzys6ZQM4KGIZiROE/view?usp=drive_link"
                    target="_blank"
                    download
                >
                    Download CV{" "}
                ...
                <div className="flex sm:flex-row gap-2">
                    <a
                        ...
                        href="https://linkedin.com/in/watcharapong-cheawwit"
                        target="_blank"
                    >
                        <BsLinkedin />
                    </a>
